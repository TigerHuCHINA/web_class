...
<body class="page_user_center user_ordinary">
...
<div class="site_cover">
	...
	<div class="cover_inner">
		...
		<p><a class="btn_edit" target="_self" href="information.jsp">编辑资料</a></p>
		</div>
		<div class="user_info_inner">
		<ul class="user_count">
		...
		<a href="javascript:void(0);" class="btn_user j_rss" data-act="set" style="display: none;">订阅</a>
		<a href="javascript:void(0);" class="btn_user j_rssed btn_rssed" data-act="del" style="display: none;">
		<span class="toggle_show"><i class="icon_yes"></i><span class="btn_rssed_inner" >已订阅</span></span>
		<span class="toggle_hide"><i class="icon_yes"></i><span class="btn_rssed_inner">取消订阅</span></span>
		</a>
		</div>
		</div>
		...
		<span class="user_qr_txt">微信分享给好友</span>
		</div>
		</div>
		</div>
	</div>
...
<script type="text/javascript">
	var g_config = {
		visited_uin : '3480681912',
		visited_euin : 'a0fe3e64f20a7b58a3943dada1d257fb',
		<!-- visited_addr : 'http://v.qq.com/vplus/a0fe3e64f20a7b58a3943dada1d257fb' -->
	};
</script>
<script type="text/javascript">
seajs.config(
